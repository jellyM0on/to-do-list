...
function addFormLabels(parent, id, text){
    const taskDateLabel = _DOM__WEBPACK_IMPORTED_MODULE_2__.make('label', parent, null)
...
function makeFormDropdowns(data, parent, type){
    for (let i = 0; i < data.length; i++){
        const listOptions = _DOM__WEBPACK_IMPORTED_MODULE_2__.make('option', parent, `${type}-dropdown`);
...
function makeForm(){
    ...
    const viewForm = _DOM__WEBPACK_IMPORTED_MODULE_2__.make('form', contentWindow, 'view-form'); 
    viewForm.setAttribute('id', 'add-task-form'); 

    const closeBtn = _DOM__WEBPACK_IMPORTED_MODULE_2__.make('button', viewForm, 'form-close-btn');
    closeBtn.textContent = 'X';
    closeBtnListener(); 
    

    _DOM__WEBPACK_IMPORTED_MODULE_2__.make('label', viewForm, null).setAttribute('for', 'task-title'); 
    ...
    const taskList = _DOM__WEBPACK_IMPORTED_MODULE_2__.make('select', viewForm, null)
    ...
    const taskPriority = _DOM__WEBPACK_IMPORTED_MODULE_2__.make('select', viewForm, null);
    ...
    const taskDescrip = _DOM__WEBPACK_IMPORTED_MODULE_2__.make('textarea', viewForm, null);
    ...
    const submitBtn = _DOM__WEBPACK_IMPORTED_MODULE_2__.make('button', viewForm, 'view-form-submit'); 
...
function addTaskListener(){
    ...
    taskForm.addEventListener('submit', function(event) {
        ...
        _DOM__WEBPACK_IMPORTED_MODULE_2__.replacePage(listPage); 
        _DOM__WEBPACK_IMPORTED_MODULE_2__.updateCardText(); 
        removeForm(); 
        };
    }); 
}; 
...
function viewFormListener(task){
    ...
    taskForm.addEventListener('submit', (event) => {
        ...
        _DOM__WEBPACK_IMPORTED_MODULE_2__.replacePage(cardList[cardList.length-1]);
    });
};
...
function addRemoveAllBtn(){
    ...
    removeTaskBtn.addEventListener('click', () => {
        ...
        tasks.forEach((task) => {
            ...
            const newArray = _add_task__WEBPACK_IMPORTED_MODULE_2__.moveTaskFrom(taskObj, list.taskList);
...
function removeTasks(taskContainer){
    ...
    removeBtn.addEventListener('click', () => {
        ...
        const newArray = _add_task__WEBPACK_IMPORTED_MODULE_2__.moveTaskFrom(task, list.taskList);
        list.taskList = newArray; 
...
function viewItems(item){
    ...
    viewBtn.addEventListener('click', () => {
            _DOM_taskform__WEBPACK_IMPORTED_MODULE_3__.makeForm(); 
            _DOM_taskform__WEBPACK_IMPORTED_MODULE_3__.viewForm(item); 
            _DOM_taskform__WEBPACK_IMPORTED_MODULE_3__.viewFormListener(item); 
        }); 
};
...
function addTaskBtn() {
    ...
    addTaskBtnn.addEventListener('click', () => {
        _DOM_taskform__WEBPACK_IMPORTED_MODULE_3__.makeForm(); 
        _DOM_taskform__WEBPACK_IMPORTED_MODULE_3__.addTaskListener(); 
    }); 
};
...
function finishTaskListener(){
    ...
    checkBox.forEach((box) => box.addEventListener('change', () => {
        ...
        if (box.checked){
            ...
            list.taskList = _add_task__WEBPACK_IMPORTED_MODULE_2__.moveTaskFrom(task, list.taskList); 
            list.finishedTasks = _add_task__WEBPACK_IMPORTED_MODULE_2__.moveTaskTo(task, list.finishedTasks); 
            updateCardText();
        }
        else if(!box.checked){
            list.finishedTasks = _add_task__WEBPACK_IMPORTED_MODULE_2__.moveTaskFrom(fTask, list.finishedTasks); 
            list.taskList = _add_task__WEBPACK_IMPORTED_MODULE_2__.moveTaskTo(fTask, list.taskList); 
            updateCardText(); 
        }
    }));
};
...
const sampledate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(2020, 2, 12), 'MM/dd/yyyy');

_DOM__WEBPACK_IMPORTED_MODULE_1__.addListBtn();
