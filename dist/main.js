...
function addListBtn() {
   ...
   const addListForm = document.querySelector('#add-list-form');
    addListBtn.addEventListener('click', () => {
        ...
        _add_list__WEBPACK_IMPORTED_MODULE_1__.getData(event.target);
