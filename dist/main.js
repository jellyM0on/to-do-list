...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root{\n    --form-visibility: block; \n}\n\nhtml, body, #content{\n    margin: 0; \n    width: 100%;\n    height: 100%;\n}\n\n#content{\n    display: flex;\n    flex-direction: row;\n}\n\n#sidebar{\n    display: flex;\n    flex-direction: column;\n    height: 100%;\n    width: 10%; \n    background-color: pink;\n    display: none;\n}\n\n#list-interface{\n    height: 100%; \n    width: 50%; \n    background-color: antiquewhite;\n}\n\n\n#add-list-form, \n#add-task-form {\n    display: none;\n}\n\n[class ^= 'list-card']{\n    background-color: aliceblue;\n    height: 200px;\n    width: 200px; \n    border:solid;\n}\n\n#task-interface{\n    height: 100%;\n    width: 50%;\n    background-color: pink;\n}\n\n.list-page{\n    height: 200px;\n    width: 100px;\n    background-color: white;\n}\n\n.to-do-list{\n    height: 50px;\n    width: 50px;\n}\n\n.high-priority{\n    background-color: pink; \n}\n\n.view-form{\n    position: absolute; \n    top: 50%;\n    left: 50%; \n}", "",{"version":3,"sources":["webpack://./src/index.css"],"names":[],"mappings":"AAAA;IACI,wBAAwB;AAC5B;;AAEA;IACI,SAAS;IACT,WAAW;IACX,YAAY;AAChB;;AAEA;IACI,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,YAAY;IACZ,UAAU;IACV,sBAAsB;IACtB,aAAa;AACjB;;AAEA;IACI,YAAY;IACZ,UAAU;IACV,8BAA8B;AAClC;;;AAGA;;IAEI,aAAa;AACjB;;AAEA;IACI,2BAA2B;IAC3B,aAAa;IACb,YAAY;IACZ,YAAY;AAChB;;AAEA;IACI,YAAY;IACZ,UAAU;IACV,sBAAsB;AAC1B;;AAEA;IACI,aAAa;IACb,YAAY;IACZ,uBAAuB;AAC3B;;AAEA;IACI,YAAY;IACZ,WAAW;AACf;;AAEA;IACI,sBAAsB;AAC1B;;AAEA;IACI,kBAAkB;IAClB,QAAQ;IACR,SAAS;AACb","sourcesContent":[":root{\n    --form-visibility: block; \n}\n\nhtml, body, #content{\n    margin: 0; \n    width: 100%;\n    height: 100%;\n}\n\n#content{\n    display: flex;\n    flex-direction: row;\n}\n\n#sidebar{\n    display: flex;\n    flex-direction: column;\n    height: 100%;\n    width: 10%; \n    background-color: pink;\n    display: none;\n}\n\n#list-interface{\n    height: 100%; \n    width: 50%; \n    background-color: antiquewhite;\n}\n\n\n#add-list-form, \n#add-task-form {\n    display: none;\n}\n\n[class ^= 'list-card']{\n    background-color: aliceblue;\n    height: 200px;\n    width: 200px; \n    border:solid;\n}\n\n#task-interface{\n    height: 100%;\n    width: 50%;\n    background-color: pink;\n}\n\n.list-page{\n    height: 200px;\n    width: 100px;\n    background-color: white;\n}\n\n.to-do-list{\n    height: 50px;\n    width: 50px;\n}\n\n.high-priority{\n    background-color: pink; \n}\n\n.view-form{\n    position: absolute; \n    top: 50%;\n    left: 50%; \n}"],"sourceRoot":""}]);
// Exports
...
function makeViewForm(){
    ...
    makeFormDropdowns(_add_list__WEBPACK_IMPORTED_MODULE_1__.allLists, taskList, 'list');
...
function makeFormDropdowns(data, parent, type){
    for (let i = 0; i < data.length; i++){
        ...
        if (data == _add_list__WEBPACK_IMPORTED_MODULE_1__.allLists){
...
function taskFormListener(){
    ...
    addTaskForm.addEventListener('submit', function(event) {
        ...
        if (_add_task__WEBPACK_IMPORTED_MODULE_2__.validateTaskName(event.target) == true) {
        _add_task__WEBPACK_IMPORTED_MODULE_2__.addT(event.target);
...
function addSelectionToForm(){
    ...
    for (let i = 0; i < _add_list__WEBPACK_IMPORTED_MODULE_1__.allLists.length; i++){
        const listOptions = make('option', listSelector,'list-dropdown');
        listOptions.setAttribute('value', _add_list__WEBPACK_IMPORTED_MODULE_1__.allLists[i].title);
        listOptions.textContent = _add_list__WEBPACK_IMPORTED_MODULE_1__.allLists[i].title; 
    };
};
...
_DOM__WEBPACK_IMPORTED_MODULE_1__.taskFormListener(); 
